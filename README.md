...
An interactive web app for learning Python: 22 lessons (basics, modules and files, then
object-oriented programming through defensive-security examples), runnable examples,
